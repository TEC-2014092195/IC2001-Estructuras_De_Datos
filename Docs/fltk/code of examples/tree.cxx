...
#include "C:/dev/fltk-1.3.2/test/tree.h"
/**
...
int main(int argc, char **argv) {
  { window = new Fl_Double_Window(1045, 580, "tree");
    ...
    { Fl_Group* o = new Fl_Group(300, 5, 731, 615);
...
u can scroll");
      ...
      { Fl_Value_Slider* o = usericonmarginleft_slider = new Fl_Value_Slider(505, 120, 155, 16, "usericonmarginleft()");
        ...
        usericonmarginleft_slider->step(0.01);
      ...
      { Fl_Value_Slider* o = labelmarginleft_slider = new Fl_Value_Slider(505, 140, 155, 16, "labelmarginleft()");
        ...
        labelmarginleft_slider->step(0.01);
      ...
      { Fl_Value_Slider* o = widgetmarginleft_slider = new Fl_Value_Slider(505, 160, 155, 16, "widgetmarginleft()");
        ...
        widgetmarginleft_slider->step(0.01);
...
item");
      ...
      { labelandwidget_radio = new Fl_Check_Button(645, 356, 20, 16, "Show label + widget");
        labelandwidget_radio->tooltip("Enables both label and widget() for display.\nWhen enabled, widget should app\
ear to the right of the item\'s label. By default, the widget() is shown in pl\
ace of the item\'s label.");
      ...
      { itemheightfromwidget_radio = new Fl_Check_Button(645, 371, 20, 16, "Item h() from widget");
        itemheightfromwidget_radio->tooltip("If enabled, item\'s height will track the widget()\'s height.\nWhen enabled, \
click \'ccc\' or \'D1/D2\' buttons to test.");
...
existing items in tree are modified.");
      ...
      { Fl_Choice* o = selected_labelfont_choice = new Fl_Choice(863, 31, 140, 21, "Fl_Tree_Item::labelfont()");
        selected_labelfont_choice->tooltip("Changes the font for the selected items\'s labels. If none selected, all are \
changed. Tests Fl_Tree_Item::labelfont();");
      ...
      { Fl_Value_Slider* o = selected_labelsize_slider = new Fl_Value_Slider(863, 55, 140, 16, "Fl_Tree_Item::labelsize()");
        selected_labelsize_slider->tooltip("Changes the font size of the selected items\'s labels. If none selected, all \
are changed. Tests Fl_Tree_Item::labelsize();");
        ...
        selected_labelsize_slider->step(0.01);
...
d, all are changed.");
      ...
      { deactivate_toggle = new Fl_Light_Button(769, 134, 95, 16, " Deactivate");
...
ll are set.");
      ...
      { bold_toggle = new Fl_Light_Button(769, 154, 95, 16, " Bold Font");
...
ms must be siblings)");
      ...
      { selectall_button = new Fl_Button(724, 199, 95, 16, "Select All");
      ...
      { deselectall_button = new Fl_Button(724, 219, 95, 16, "Deselect All");
      ...
      { bbbselect_toggle = new Fl_Light_Button(819, 199, 95, 16, " Select Bbb");
      ...
      { bbbselect2_toggle = new Fl_Light_Button(819, 219, 95, 16, " Select Bbb+");
      ...
      { bbbchild02select_toggle = new Fl_Light_Button(819, 239, 95, 16, " Toggle child-02");
      ...
      { rootselect_toggle = new Fl_Light_Button(914, 199, 95, 16, "Select ROOT");
      ...
      { rootselect2_toggle = new Fl_Light_Button(914, 219, 95, 16, "Select ROOT+");
      ...
      { Fl_Box* o = new Fl_Box(695, 298, 335, 244, "Tree Fonts + Colors");
        o->tooltip("These controls only affect the selected items. If no items are selected, all \
existing items in tree are modified.");
        o->box(FL_GTK_DOWN_BOX);
        o->color(FL_DARK1);
      ...
      { Fl_Choice* o = labelfont_choice = new Fl_Choice(850, 319, 140, 21, "labelfont()");
...
ems.");
      ...
      { Fl_Value_Slider* o = labelsize_slider = new Fl_Value_Slider(850, 343, 140, 16, "labelsize()");
...
em::labelsize() or Fl_Tree::item_labelsize()");
      ...
      { Fl_Choice* o = item_labelfont_choice = new Fl_Choice(850, 363, 140, 21, "Item_labelfont()");
...
ose font has NOT specifically been set with item->labelfont().");
      ...
      { Fl_Value_Slider* o = item_labelsize_slider = new Fl_Value_Slider(850, 388, 140, 16, "item_labelsize()");
...
ms whose font size has NOT specifically been set with item->labelsize().");
      ...
      { Fl_Button* o = labelcolor_button = new Fl_Button(815, 458, 16, 16, "labelcolor()");
...
label.");
      ...
      { Fl_Button* o = color_button = new Fl_Button(815, 477, 16, 16, "color()");
...
gcolor() hasn\'t been changed.");
      ...
      { Fl_Button* o = selection_color_button = new Fl_Button(815, 496, 16, 16, "selection_color()");
...
ey\'re selected.");
      ...
      { Fl_Button* o = item_labelfgcolor_button = new Fl_Button(975, 458, 16, 16, "item_labelfgcolor()");
      ...
      { item_labelbgcolor_button = new Fl_Button(975, 477, 16, 16, "item_labelbgcolor()");
...
ides the default behavior of using Fl_Tree::color().");
      ...
      { x_item_labelbgcolor_button = new Fl_Button(995, 477, 16, 16, "X");
